...
void cmd_help(const char* args, const char* flag) {
    ...
    #define HELP_LINE(cmd, flags, desc, ccol, fcol) \
        graphics_console_set_color(rgb16(255,255,0), rgb16(0,0,0)); print(cmd); \
        for (int i = kstrlen(cmd); i < ccol; i++) print(" "); \
        graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print(flags); \
        for (int i = kstrlen(flags); i < fcol; i++) print(" "); \
        graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print(desc); print("\n");
    ...
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); // restore soft white
    #undef HELP_LINE
}

// Per-command help stubs (mimic --help output)
static void help_clear(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: clear\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Clears the screen.\n");
}
static void help_count(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: count\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Shows the number of timer and keyboard interrupts.\n");
}
static void help_echo(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: echo ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<text>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Prints text to the screen.\nYou can also use: echo <text> > <file> to write to a file, or echo <text> >> <file> to append.\n");
}
static void help_ls(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: ls ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("[dir]\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Lists all files and directories in the given directory (default: current).\n");
}
static void help_cat(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: cat ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<file>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Shows the contents of a file.\n");
}
static void help_edit(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: edit ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<file>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Edits a file.\n");
}
static void help_pwd(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: pwd\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Shows the current working directory.\n");
}
static void help_cd(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: cd ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<dir>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Changes the current working directory.\n");
}
static void help_mkdir(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: mkdir ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<dir>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Creates a new directory.\n");
}
static void help_rm(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: rm ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<file|dir>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Removes a file or an empty directory.\n");
}
static void help_touch(void) {
    graphics_console_set_color(rgb16(0,255,128), rgb16(0,0,0)); print("Usage: touch ");
    graphics_console_set_color(rgb16(255,128,0), rgb16(0,0,0)); print("<file>\n");
    graphics_console_set_color(rgb16(220,220,220), rgb16(0,0,0)); print("Creates an empty file or updates its timestamp (not implemented).\n");
} 